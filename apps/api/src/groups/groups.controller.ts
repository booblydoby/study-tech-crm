...
export class GroupsController {
  ...
  getStudents(@Param("id") id: string) {
    return this.groups.getStudents(id);
  }
  ...
  resetStudentPrice(@Param("id") id: string, @Param("studentId") studentId: string) {
    return this.groups.resetStudentPrice(id, studentId);
  }

  @Post(":id/sync-prices")
  syncPrices(@Param("id") id: string) {
    return this.groups.syncPricesToAll(id);
  }

  @Post(":id/students")
  addStudent(@Param("id") id: string, @Body() dto: AddStudentToGroupDto) {
    return this.groups.addStudent(id, dto);
  }
  ...
  @Post(":id/teachers")
  addTeacher(@Param("id") id: string, @Body() dto: AddTeacherToGroupDto) {
    return this.groups.addTeacher(id, dto);
  }

  @Get(":id/schedule")
  schedule(@Param("id") id: string) {
    return this.groups.schedule(id);
  }
}
